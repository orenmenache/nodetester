DROP TABLE IF EXISTS AmericanFootball.RAPID__LASTMATCHES;
CREATE TABLE IF NOT EXISTS AmericanFootball.RAPID__LASTMATCHES (
    id INT PRIMARY KEY,
    ...
    winner_code VARCHAR(20) NOT NULL, -- 0: Draw, 1: Home, 2: Away
