DROP TABLE IF EXISTS Baseball.CORE__LEAGUESEASONS;
CREATE TABLE IF NOT EXISTS Baseball.CORE__LEAGUESEASONS (
    id INT PRIMARY KEY,
    ...
    FOREIGN KEY (tournament_id) REFERENCES Baseball.CORE__TOURNAMENTS(id)
)